...
'''
Ревьювер сказал "Вместо полотна иф-елиф-елз можно написать словарь, в котором 
ключи - символы операций, а значения - ссылки на функции, которые выполняют эти
операции. Тогда нам нужно будет только брать из словаря функцию и применять ее
к двум операндам"
